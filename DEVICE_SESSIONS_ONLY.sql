/*
  # Device Sessions Only Function

  1. Purpose
    - Simplified function that returns ONLY device sessions
    - No human submission sessions included
    
  2. Returns
    - Active device sessions (status = 'in_progress')
