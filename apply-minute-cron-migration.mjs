...
console.log('🚀 Applying minute-level cron support migration...\n');
...
console.log('   • 0,30 * * * * = Twice per hour');
console.log('   • 0 */6 * * * = Every 6 hours (backward compatible)\n');
console.log('⚠️  Battery warning: Sub-hourly schedules drain ~12x faster\n');
