/*
  # FORCE FIX: Replace generate_session_wake_snapshot with correct EXTRACT syntax

  This drops and recreates the function with the correct interval day extraction.
*/
...
BEGIN
  ...
  RAISE NOTICE '✅ SUCCESS! Function works. Snapshot ID: %', test_result;
