...
BEGIN
  INSERT INTO device_history (
    ...
    'info',
    format('Wake schedule changed to: %s (effective: %s)', NEW.new_schedule, NEW.effective_date::date),
    jsonb_build_object(
      'new_schedule', NEW.new_schedule,
      'previous_schedule', NEW.previous_schedule,
...
SELECT
  ...
  'wake_schedule_updated',
  'info'::event_severity,
  format('Wake schedule changed to: %s (effective: %s)', dsc.new_schedule, dsc.effective_date::date),
  jsonb_build_object(
    'new_schedule', dsc.new_schedule,
    'previous_schedule', dsc.previous_schedule,
    'effective_date', dsc.effective_date,
    'change_reason', dsc.change_reason
  ),
  jsonb_build_object(
